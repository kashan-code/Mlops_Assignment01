...
<head>
    ...
    <style>
        ...
        .stress-1 { color: #38a169; }
        .stress-2 { color: #68d391; }
        .stress-3 { color: #f6ad55; }
        .stress-4 { color: #fc8181; }
        .stress-5 { color: #e53e3e; }
        .confidence {
            background: #edf2f7;
            padding: 10px;
            border-radius: 5px;
...
5: "Very high stress levels. Please consider seeking professional support and
implementing stress reduction strategies immediately."};
